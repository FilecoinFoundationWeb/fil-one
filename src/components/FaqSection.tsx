...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Fil One is optimized for warm and cold storage workloads — large datasets, backups, archives, and long-term retention.",
  },
  {
    question: "Where is my data stored?",
    answer:
      "Your data is stored on the Filecoin network. Unlike traditional cloud storage, no single company or data center controls your data — promoting portability and durability, and protecting against single points of failure.",
  },
  {
    question: "What is Filecoin?",
    answer:
      "Filecoin is a distributed storage network launched in 2020, designed for 100% data portability and auditability — and fundamentally against hyperscaler lock-in.",
  },
];
