      ...
      >
          ...
          <div style={{ minWidth: 560 }}>
            ...
            <div className="grid w-full" style={{ gridTemplateColumns: "200px 1fr 1fr" }}>
              ...
              <div className="px-6 py-6 flex items-center">
                <span style={{ fontFamily: "'Funnel Sans', sans-serif", fontWeight: 500, fontSize: 15, color: "#09090B" }}>
                  Traditional Cloud
                </span>
              </div>
              <div
                className="px-6 py-6 rounded-t-2xl flex items-center"
                style={{ backgroundColor: "#FFFFFF", borderTop: "1px solid rgba(0,0,0,0.08)", borderLeft: "1px solid rgba(0,0,0,0.08)", borderRight: "1px solid rgba(0,0,0,0.08)" }}
              >
                <FilecoinLogo />
              </div>
            </div>
            ...
            {comparisonRows.map((row) => (
              <div key={row.feature} className="grid w-full" style={{ gridTemplateColumns: "200px 1fr 1fr" }}>
                <div className="px-4 py-5 flex items-center" style={{ borderTop: "1px solid rgba(0,0,0,0.06)" }}>
                  <span style={{ fontFamily: "'Funnel Sans', sans-serif", fontWeight: 500, fontSize: 13, color: "#09090B" }}>
                    {row.feature}
                  </span>
                </div>
                <div className="px-6 py-5 flex items-center" style={{ borderTop: "1px solid rgba(0,0,0,0.06)" }}>
                  <span style={{ fontFamily: "'Funnel Sans', sans-serif", fontWeight: 400, fontSize: 13.5, lineHeight: "1.45", color: "#71717A" }}>
                    {row.traditional}
                  </span>
                </div>
                <div className="px-6 py-5 flex items-center" style={{ backgroundColor: "#FFFFFF", borderTop: "1px solid rgba(0,0,0,0.08)", borderLeft: "1px solid rgba(0,0,0,0.08)", borderRight: "1px solid rgba(0,0,0,0.08)" }}>
                  <span style={{ fontFamily: "'Funnel Sans', sans-serif", fontWeight: 400, fontSize: 13.5, lineHeight: "1.45", color: "#09090B" }}>
                    {row.filHyperspace}
                  </span>
                </div>
              </div>
            ...
            <div className="grid w-full" style={{ gridTemplateColumns: "200px 1fr 1fr" }}>
              ...
              <div
                ...
                style={{ backgroundColor: "#FFFFFF", borderTop: "1px solid rgba(0,0,0,0.08)", borderBottom: "1px solid rgba(0,0,0,0.08)", borderLeft: "1px solid rgba(0,0,0,0.08)", borderRight: "1px solid rgba(0,0,0,0.08)" }}
              >
        ...
        <div className="md:hidden flex flex-col">
          ...
          <div className="grid grid-cols-2">
            ...
            <div
              className="px-3 py-4 rounded-t-xl flex items-center"
              style={{ backgroundColor: "#FFFFFF", borderTop: "1px solid rgba(0,0,0,0.08)", borderLeft: "1px solid rgba(0,0,0,0.08)", borderRight: "1px solid rgba(0,0,0,0.08)" }}
            >
              <FilecoinLogo />
            </div>
          ...
          {/* Each row: feature label + traditional value (left), Filecoin value (right card) */}
          {comparisonRows.map((row) => (
            <div
              key={row.feature}
            ...
            >
              <div className="pr-3 py-4 flex flex-col gap-1.5">
                <span style={{ fontFamily: "'Funnel Sans', sans-serif", fontWeight: 500, fontSize: 11, letterSpacing: "0.05em", textTransform: "uppercase" as const, color: "#A1A1AA" }}>
                  {row.feature}
                </span>
                <span style={{ fontFamily: "'Funnel Sans', sans-serif", fontWeight: 400, fontSize: 13, lineHeight: "1.5", color: "#71717A" }}>
                  {row.traditional}
                </span>
              </div>
              <div
                className="px-3 py-4 flex items-center"
                style={{ backgroundColor: "#FFFFFF", borderLeft: "1px solid rgba(0,0,0,0.08)", borderRight: "1px solid rgba(0,0,0,0.08)" }}
              >
                <span style={{ fontFamily: "'Funnel Sans', sans-serif", fontWeight: 400, fontSize: 13, lineHeight: "1.5", color: "#09090B" }}>
                  {row.filHyperspace}
                </span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2" style={{ borderTop: "1px solid rgba(0,0,0,0.06)" }}>
            ...
            >
              <a href="https://fil-hyperspace.vercel.app/" className="btn-primary w-full">
                <span className="btn-primary-inner w-full justify-center" style={{ fontSize: 13, padding: "7px 12px" }}>Contact sales</span>
              </a>
            </div>
          </div>
        </div>
